...
import main.java.br.com.luan.dao.ProdutoDAO;
...
public class ProdutoDAOTest {
    ...
    private Produto criarProduto(String codigo) throws TipoChaveNaoEncontradaException, DAOException {
        ...
        produto.setEstoque(50); // Adicionando o estoque ao produto
    ...
    public void pesquisar() throws MaisDeUmRegistroException, TableException, DAOException, TipoChaveNaoEncontradaException {
        ...
        Assert.assertEquals(50, Optional.ofNullable(produtoDB.getEstoque())); // Verificando se o estoque foi adicionado corretamente ao consultar o produto
